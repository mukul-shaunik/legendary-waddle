...
#       See https://stackoverflow.com/questions/16854041/bash-read-is-being-skip
ped-when-run-from-curl-pipe
#
#   2.  It also has practical risks of running a partially downloaded script, wh
ich could be dangeresque
...
if [ -e "usr/share/install_helper.sh" ]; then
  ...
  http_bash https://git.coolaj86.com/coolaj86/telebit.js/raw/branch/$TELEBIT_VER
SION/usr/share/install_helper.sh "$@"
fi
